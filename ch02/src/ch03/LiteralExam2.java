...
public class LiteralExam2 {
	...
	public static void main(String[] args) {
		...
		int b = 0b0101;	// 정수타입 변수를 선언하고 2진서0b0101을 대입
				
		System.out.println(n); //15 -  1*10^1 + 5*10^0      ^(제곱을뜻함)
		...
		long l1 = 24l; //long 타입 정수 변수를 선언하고 long타입 리터럴을 대입
		
		// = 은 대입을 처리하는 대입 연산자임. 
		// = 을 기준으로 왼쪽 타입과 오른쪽 타입을 비교하면 
		// 연산자인 = 의 왼쪽은 범위가 넓은 정수타입 오른쪽은 범위가 좁은 정수타입
		//	정수타입 24가 24L로 변해서 저장
		
		long l2 = 24; //long 타입 변수를 선언하고 int정수타입 리터럴을 대입
